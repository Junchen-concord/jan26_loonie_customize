...
path = "C:/CIPModels/Data/CashMax/Transactions/"
# path = "C:/CIPModels/Data/CashMax/Transactiontest/"
...
for file in dir_list:
    ...
    command = (
        "C:/Anaconda3/envs/MDLV16/python.exe C:/CIPModels/PythonService/IAModelV16/test_scripts/run_cashmax_for_notazo_load_to_db.py "
        + fullpath
    )
